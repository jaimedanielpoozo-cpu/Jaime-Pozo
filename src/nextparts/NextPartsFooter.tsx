...
export default function NextPartsFooter() {
  return (
    <footer className="border-t border-border/15 bg-background px-6 py-14 sm:px-10">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:justify-between sm:text-left">
        <div>
          <img src={logo} alt="Next Parts" className="h-12 w-12 rounded-xl" />
      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-border/15 pt-6 text-center text-xs text-muted-foreground">
